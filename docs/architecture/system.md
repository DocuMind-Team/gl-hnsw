...
系统的装配入口在 [src/hnsw_logic/app/container.py](../src/hnsw_logic/app/container.py)。
...
- [src/hnsw_logic/storage/corpus_store.py](../src/hnsw_logic/storage/corpus_store.py)
- [src/hnsw_logic/storage/document_loader.py](../src/hnsw_logic/storage/document_loader.py)
- [src/hnsw_logic/storage/document_preprocessor.py](../src/hnsw_logic/storage/document_preprocessor.py)
...
- [src/hnsw_logic/indexing/index_builder.py](../src/hnsw_logic/indexing/index_builder.py)
- [src/hnsw_logic/retrieval/searcher.py](../src/hnsw_logic/retrieval/searcher.py)
...
- [src/hnsw_logic/indexing/supervisor.py](../src/hnsw_logic/indexing/supervisor.py)
- [src/hnsw_logic/indexing/discovery.py](../src/hnsw_logic/indexing/discovery.py)
- [src/hnsw_logic/indexing/pipeline.py](../src/hnsw_logic/indexing/pipeline.py)
...
核心模型定义在 [src/hnsw_logic/domain/models.py](../src/hnsw_logic/domain/models.py)。
...
该逻辑在 [src/hnsw_logic/indexing/discovery.py](../src/hnsw_logic/indexing/discovery.py) 中实现。
